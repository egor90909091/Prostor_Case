...
/// Администратор платформы на бэкенд не влияет — его роль целиком в том, что
/// показывает интерфейс (сводная аналитика и все заявки), поэтому отдельного
/// значения заголовка для него нет.
///
